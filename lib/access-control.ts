...
const roleRoutes: Record<string, string[]> = {
  administrator: ["*"],
  admin: ["*"],
  ceo: ["/", "/members", "/mam", "/remittances", "/programs", "/branches", "/cash-transactions", "/settings"],
  president: ["/", "/members", "/mam", "/remittances", "/programs", "/branches", "/cash-transactions", "/settings"],
  ...
  finance: ["/", "/members", "/collections", "/remittances", "/mam", "/programs", "/expenses", "/cash-transactions", "/settings"],
  "entry clerk": ["/", "/new-sales", "/members", "/collections", "/attendance", "/leave-requests", "/settings"],
